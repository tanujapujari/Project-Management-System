  ...
  const getActionText = (log) => {
    ...
    if (action.includes("Project")) {
      ...
      if (action.includes("Created")) {
        ...
        const statusChange = action.split(" - ")[1];
        ...
        actionText = `Performed an action on project "${projectTitle}"`;
      }
    }
    // Task Actions
      ...
      if (action.includes("Created")) {
        ...
        actionText = `Performed an action on task "${taskTitle}" in project "${projectTitle}"`;
      }
    }
    // Comment Actions
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 relative">
            <button
              className="p-3 rounded-full hover:bg-gradient-to-r hover:from-blue-400
               hover:to-purple-400 hover:text-white transition-all duration-300"
              onClick={toggleTheme}
            ...
            {dropdownOpen && (
              <div
                className="absolute right-0 top-14 bg-white dark:bg-black shadow-md
               rounded-md p-2 w-32"
              >
                <button
